"""
fetch_2025_data.py — Fetch all data needed for 2025 OOS backtest.

Checks and fetches:
  1. 5-min OHLCV parquets for 2025 (all tickers in window_debug universe)
...
print("\n" + "="*60)
print("STEP 1: Check 5-min data coverage for 2025")
print("="*60)
...
if not missing:
    print(f"  All {len(ALL_TICKERS_5MIN)} tickers have 2025 data in pkl. No 5-min fetch needed.")
