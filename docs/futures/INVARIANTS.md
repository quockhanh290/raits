...
| fit_A degradation floor = **Calmar 1.57** (frozen, 2-tick, causal, MAX_HOLD 09:30) | `deploy_sim --data-dir data\cache\futures\frozen_sim --nkd-parquet global_index/data/NKD_frozen_2024.parquet --regime-csv spy_daily_live.csv --end 2024-12-31 --hmm-fit-end 2022-12-31 --n-contracts 1 --slippage-ticks 2` → Calmar=1.57, net=$40,642 | floor/baseline=94.6% (1.57/1.66) — headroom +5.7%. Tight nhưng baseline > floor ✓. Deprecated: 1.53 (bar-0 exit, floor/baseline=89% trên convention cũ). Dirty floor 2.04 deprecated (look-ahead). |
...
| Live Calmar floor = **1.57** (fit_A, frozen, 2-tick, causal, MAX_HOLD 09:30) | vault result files — Calmar > 1.57 | 2-tick + causal + 09:30 convention. Vaults pass: 2.77 > 1.57 ✓, 3.39 > 1.57 ✓. Deprecated: 1.53 (bar-0 exit). Dirty floor 2.04 deprecated. |
