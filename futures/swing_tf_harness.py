...
"""
# CANONICAL harness cho futures (co return_open param). Source reference cua
# futures/_validated_core.backtest_swing_tf. Ban root swing_tf_harness.py la cho pool scripts.
